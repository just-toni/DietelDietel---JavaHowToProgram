...
import FirstSetOfTddPractice.Television;
...
class TelevisionTest {
    ...
    @Test
    void testThatTvCantChangeToNextChannelGreaterThanTwentyWhenSwitchedOn(){
        boolean isOn = true;
        tv.isOn(isOn);
        int channel = 20;
        tv.setChannel(channel);
    ...
    void testThatTvCanChangeToPreviousChannelWhenSwitchedOn(){
        ...
        assertEquals(19, tv.getChannel());
    }

    @Test
    void testThatTvCantChangeToPreviousChannelLessThanOneWhenSwitchedOn(){
        boolean isOn = true;
        tv.isOn(isOn);
        int channel = 1;
        tv.setChannel(channel);
    ...
    @Test
    void testThatTvCanTDecreaseVolumeLessThanZeroWhenSwitchedOn(){
        boolean isOn = true;
        tv.isOn(isOn);
        int volume = 0;
        tv.setVolume(volume);
