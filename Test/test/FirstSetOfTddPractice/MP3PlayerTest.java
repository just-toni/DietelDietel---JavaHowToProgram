...
import FirstSetOfTddPractice.MP3Player;
...
class MP3PlayerTest {
    ...
    @Test
    void testThatMP3PlayerCantSetCurrentPlayingTrackGreaterThanHindredWhenSwitchedOn(){
        boolean isOn = true;
        playlist1.isOn(isOn);
        int currentPlayingTrack = 101;
        playlist1.setCurrentPlayingTrack(currentPlayingTrack);
        assertEquals(1, playlist1.getCurrentPlayingTrack());
    }
    ...
    @Test
    void testThatMP3PlayerCantChangeToNextTrackGreaterThanHundredWhenSwitchedOn(){
        boolean isOn = true;
        playlist1.isOn(isOn);
        int nextTrack = 100;
        playlist1.setCurrentPlayingTrack(nextTrack);
    ...
    @Test
    void testThatMP3PlayerCantChangeToPreviousTrackLessThanOneWhenSwitchedOn(){
        boolean isOn = true;
        playlist1.isOn(isOn);
        int nextTrack = 1;
        playlist1.setCurrentPlayingTrack(nextTrack);
        playlist1.setPreviousTrack();
        assertEquals(100, playlist1.getCurrentPlayingTrack());
    }
    ...
    @Test
    void testThatMP3PlayerCantDecreaseVolumeLessThanZeroWhenSwitchedOn(){
        boolean isOn = true;
        playlist1.isOn(isOn);
        int volume = 0;
        playlist1.setVolume(volume);
